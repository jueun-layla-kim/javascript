// Math Object
{
    ...
    // console.log(Math.round(sum)); // 소수점 첮째 자리에서 반올림해서 정수 반환
    // console.log(Math.ceil(sum)); // 소수점 첮째 자리에서 무조건 올림해서 정수 반환
    // console.log(Math.floor(sum)); // 소수점 첮째 자리에서 무조건 내림해서 정수 반환
